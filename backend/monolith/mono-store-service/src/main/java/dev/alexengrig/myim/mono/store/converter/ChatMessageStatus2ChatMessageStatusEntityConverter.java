...
public interface ChatMessageStatus2ChatMessageStatusEntityConverter
        extends Converter<ChatMessageStatus, ChatMessageStatusEntity> {

    @Override
    ChatMessageStatusEntity convert(ChatMessageStatus source);
