...
public interface ChatMessageStatusEntity2ChatMessageStatusConverter
        extends Converter<ChatMessageStatusEntity, ChatMessageStatus> {

    @Override
    ChatMessageStatus convert(ChatMessageStatusEntity source);
