...
@SpringBootTest(classes = UserRegistrationRequest2ApplicationUserDetailsConverterImpl.class)
class UserRegistrationRequest2ApplicationUserDetailsConverterTest {

    @Autowired
    UserRegistrationRequest2ApplicationUserDetailsConverter converter;

    @Test
    void should_convert() {
        UserRegistrationRequest source = UserRegistrationRequest.builder()
