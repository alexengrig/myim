...
public interface AuthorEntity2ApplicationUserDetailsConverter
        extends Converter<AuthorEntity, ApplicationUserDetails> {

    @Override
    ApplicationUserDetails convert(AuthorEntity source);
